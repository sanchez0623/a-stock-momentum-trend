...
// forwardRef: AnimatePresence(popLayout) 会给子组件传 ref 做尺寸测量,
// 函数组件必须透传 ref(React 19 否则告警 "Function components cannot be given refs")
const ToastCard = forwardRef<HTMLDivElement, { item: ToastItem; onDone: (id: number) => void }>(
  function ToastCard({ item, onDone }, ref) {
